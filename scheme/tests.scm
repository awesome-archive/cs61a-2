...
(define add-nums (lambda (x y) (lambda (z) (+ x y z))))
; expect add-nums
...
(define (nested-lambda) (lambda (a b) (lambda (x y z) (lambda (c) (+ a b x y z c)))))
; expect nested-lambda

((((nested-lambda) 1 4) 2 15 0) 3)
; expect 25

'(hello world (2 0 1 . 8) !)
; expect (hello world (2 0 1 . 8) !)
...
(let ((x 4) (y (+ x 2)) (z 7)) (+ (* x y) z))
; expect 27

(define mu-test (mu (z) (* x y z)))
; expect mu-test

(define (mu-func x y) (mu-test 5))
; expect mu-func
...
(define-macro (thrice n) (list 'begin n n n))
; expect thrice
