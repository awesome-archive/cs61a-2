...
def free_bacon(score):
    ...
    right_num:  The number on the right side of a 2-digit number
    left_num:   The number on the left side of a 2-digit number
    """
    assert score < 100, 'The game should be over.'
    # BEGIN PROBLEM 2
    right_num = score % 10
    left_num = (score - right_num) // 10
    return 2 + abs(left_num - right_num)
    # END PROBLEM 2
...
def announce_highest(who, previous_high=0, previous_score=0):
    ...
    def say(score0, score1):
        ...
        if score_change > prev_high:
            if score_change == 1:
                print("1 point! That's the biggest gain yet for Player", who)
            else:
                print(score_change, "points! That's the biggest gain yet for Player", who)
            prev_high = score_change
...
def make_averaged(fn, num_samples=500):
...
def max_scoring_num_rolls(dice=six_sided, num_samples=1000):
    ...
    i, highest_average, best_num_roll = 1, 0, 0

    while i <= 10:
        current_average = average(i, dice)
        if current_average > highest_average:
            highest_average, best_num_roll = current_average, i
        i += 1
